...
import MomentumImg from "../../assets/master_momentum_trading.png";
            ...
            <div className="lg:w-5/12 relative border-l border-white/10 p-6 md:p-8 overflow-hidden bg-gradient-to-b from-[#00000000] via-[#5928E54D] via-30%">
              ...
              <div className="relative z-10 space-y-8 leading-relaxed">
                  ...
                  <div>
                    <div>
                      ...
                      <p className="text-lg font-bold text-white">
                        ₹12,999/- +{" "}
                        <span className="text-xs font-light"> GST 18%</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <span className="text-xs text-gray-50">
                  For Definedge Super Demat Account Holders 20% Off <br />
                ...
                <button
                  ...
                  className="shine shine-anim w-full bg-[#5928E5] hover:bg-[#4a1fd1] text-white font-bold py-3 px-6 rounded-xl shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl"
                >
